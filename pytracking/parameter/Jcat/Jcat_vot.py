...
def parameters():
    ...
    params.max_image_sample_size = (20 * 18) ** 2   # Maximum image sample size
    params.min_image_sample_size = (20 * 18) ** 2   # Minimum image sample size
    ...
    # Training parameters
    params.sample_memory_size = 300              # Memory size
    ...
    params.segm_update_skip = 20                          # How often to run segmentation updating (every n-th frame)
