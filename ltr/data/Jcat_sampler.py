...
class JcatSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Get frames
        train_frames, train_masks, train_anno, _ = dataset.get_frames(seq_id, train_frame_ids, anno)
        test_frames, test_masks, test_anno, _ = dataset.get_frames(seq_id, test_frame_ids, anno)
