...
import ltr.models.Jcat as segmmodels
...
@model_constructor
def Jcat_resnet18(segm_input_dim=(256,256), segm_inter_dim=(256,256), backbone_pretrained=True, topk_pos=3, topk_neg=3, mixer_channels=2):
    # backbone
    ...
    # segmentation
    segm_predictor = segmmodels.JcatNet(segm_input_dim=segm_input_dim,
    ...
    net = JcatNet(feature_extractor=backbone_net, segm_predictor=segm_predictor,
...
@model_constructor
def Jcat_resnet50(segm_input_dim=(256,256), segm_inter_dim=(256,256), backbone_pretrained=True, topk_pos=3, topk_neg=3, mixer_channels=2):
    # backbone
